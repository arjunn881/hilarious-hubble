---
title: "Can You Bring a Beard Trimmer on a Plane? TSA Rules Explained"
description: "Can you bring a beard trimmer or electric shaver on a plane? Full TSA carry-on and checked baggage rules for trimmers, electric razors, and shavers."
...
- **Carry-On Baggage (Cabin):** ✅ Allowed
- **Checked Baggage (Hold):** ✅ Allowed (with conditions for lithium batteries)
...
- The FAA's concern is that lithium battery fires in the cargo hold cannot be quickly suppressed

Most major airlines — Delta, United, American, Ryanair, British Airways — follow this same rule. The device itself is fine; it's the battery location that matters.

> [!IMPORTANT]
> If your trimmer has a lithium battery, pack it in your carry-on whenever possible. If you must check it, ensure the device is completely powered off and, if possible, remove the battery and pack it separately in your carry-on.

### Electric Shavers
Electric shavers (rotary or foil type) follow the identical rules as beard trimmers. Whether it's a Braun, Philips, Panasonic, or Gillette electric shaver — **allowed in carry-on and checked baggage**.
...
| Airline | Trimmer Policy |
|---|---|
| **Delta** | Follows TSA/FAA rules. Lithium devices recommended in carry-on |
| **United Airlines** | Same as TSA. Rechargeable devices must be protected from accidental activation |
| **American Airlines** | Trimmers allowed in carry-on and checked |
| **Ryanair** | Allowed in carry-on within size limits. Electric items accepted |
| **British Airways** | Follows UK CAA rules — same as TSA for trimmers |
| **Emirates** | Allowed. Lithium battery devices in cabin preferred |
...
**Q: Can I bring a beard trimmer in my carry-on?**
A: Yes. Beard trimmers and electric shavers are fully allowed in carry-on bags. There is no TSA restriction on grooming trimmers in the cabin.

**Q: Does a trimmer need to be in carry-on or checked luggage?**
...
**Q: Can I put my electric shaver in checked baggage?**
A: Yes, but power it fully off before packing. If it has a lithium battery, carry-on is safer and preferred.

**Q: Are beard trimmers allowed on international flights?**
A: Yes. TSA rules apply for US departures. Most international aviation authorities (UK CAA, EASA, CASA) follow similar policies — trimmers are universally accepted.

---

## Conclusion

Beard trimmers and electric shavers are one of the most travel-friendly grooming items you can pack. TSA allows them in both carry-on and checked luggage. The only nuance is the battery: lithium battery devices are safer and more policy-compliant when packed in your carry-on rather than checked bags. Pack your trimmer in your carry-on, turn it off, and you'll have zero issues at security.

---

## Official References

- [TSA What Can I Bring — Electric Razors](https://www.tsa.gov/travel/security-screening/whatcanibring/items/electric-razors-and-shavers)
