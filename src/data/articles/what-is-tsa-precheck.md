...
```mermaid
graph TD
    A["Receive Known Traveler Number (KTN)"] --> B["Save KTN to Frequent Flyer Airline Profiles"]
    B --> C["Book Flight (Ensure Name Exactly Matches ID)"]
    C --> D["Boarding Pass Shows 'TSA PRE' Logo"]
