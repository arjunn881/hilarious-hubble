---
title: "Can You Bring Bananas on a Plane? TSA & Customs Rules"
description: "Can you bring bananas through TSA or on a plane? Find out the carry-on rules, international customs restrictions, and what happens at airport security."
...
- **Carry-On Baggage (Cabin):** ✅ Allowed (domestic US flights)
- **Checked Baggage (Hold):** ✅ Allowed (domestic US flights)
- **TSA Declaration Required:** No (for domestic)
- **International Flights:** ⚠️ Depends on destination country
...
| Destination | Rule for Bananas |
|---|---|
| **Australia** | ❌ Fresh fruit prohibited — must declare and will be confiscated |
| **New Zealand** | ❌ Fresh fruit generally prohibited — strict biosecurity |
| **USA (arrivals)** | ⚠️ Must declare. Commercially packaged OK; some fresh fruit restricted |
| **Canada** | ⚠️ Generally allowed from many countries; must declare |
| **UK** | ⚠️ Allowed from some countries; restricted from others post-Brexit |
| **Japan** | ⚠️ Must declare. Subject to phytosanitary inspection |
| **Singapore** | ✅ Generally allowed with declaration |
| **EU countries** | ⚠️ Fresh fruit from non-EU countries subject to phytosanitary controls |

---

## Why Are Bananas Sometimes Not Allowed on Planes?

You may have heard the myth that "bananas aren't allowed on planes." This is a misunderstanding — **TSA does not ban bananas**. The confusion comes from:

1. **International customs rules** — passengers having bananas confiscated at arrival customs, not at departure security
2. **Fishing superstition** — an old maritime myth that has nothing to do with aviation rules
3. **Airline food bans** — some passengers confuse individual airline food policies (like nut-free flights) with TSA rules

The TSA has no banana ban. The question is only relevant at international customs on arrival.
...
**Q: Can I bring bananas to Canada?**
A: Generally yes, bananas are allowed into Canada from most countries. You must declare all food items on your customs declaration form.

---

## Conclusion

Bananas are perfectly fine to bring through TSA on domestic US flights — pack as many as you need for your snack supply. For international travel, the rules shift from security (TSA's domain) to biosecurity (customs' domain). Always check the customs requirements for your destination country, eat your fresh fruit during the flight if needed, and always declare food items on your arrival customs card. When in doubt, stick to packaged banana snacks for international travel.

---

## Official References

- [TSA Food and Snacks Guidelines](https://www.tsa.gov/travel/security-screening/whatcanibring/items/food)
