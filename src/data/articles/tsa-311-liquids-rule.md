...
When passing through airport security, you must adhere strictly to the capacity limits for any non-solid substance.

- **Carry-On Baggage (Cabin):** Restricted to 3.4 oz (100ml) containers
- **Checked Baggage (Hold):** Allowed (Unlimited)
- **TSA Declaration Required:** No (Unless exempt)
...
> [!IMPORTANT]
> Any liquid container larger than 3.4 ounces must be packed in your checked baggage, regardless of the amount of liquid inside. Attempting to bring a half-empty 6 oz bottle of shampoo through security will result in immediate confiscation.

### The Science Behind the Rule
The 3-1-1 rule was established following the 2006 transatlantic aircraft plot, where terrorists planned to detonate liquid explosives disguised as ordinary beverages. The 3.4 oz limit was specifically calculated as a safe threshold; even if illicit liquids were combined from multiple small containers, it would not yield a critical mass required to compromise an aircraft hull.
...
| Deodorant Type | TSA Liquid Rule Applies? | Carry-On Limit |
|---|---|---|
...
**Gel, aerosol, and cream deodorant** are subject to the TSA 3-1-1 liquid limit: each container must be 3.4 oz (100ml) or less and must fit inside your single quart-sized bag.

> [!IMPORTANT]
> A half-full gel deodorant tube that is larger than 3.4 oz is still not allowed in carry-on. TSA measures the container size, not the amount remaining.

---

## Is Toothpaste a Liquid Under TSA Rules?

Yes — **toothpaste is classified as a gel/paste by TSA** and is subject to the 3-1-1 liquid limit rule.

- **Carry-On:** Toothpaste containers must be **3.4 oz (100ml) or less**. Standard travel-size toothpaste tubes (1 oz, 2.7 oz) are fully compliant.
- **Checked Bag:** Any size toothpaste is allowed with no restrictions.
...
**Standard toothpaste tube sizes and TSA compliance:**
- 0.85 oz (mini travel) — ✅ Allowed in carry-on
- 1.0 oz — ✅ Allowed in carry-on
- 2.7 oz — ✅ Allowed in carry-on
- 3.4 oz (100ml) — ✅ Allowed in carry-on (max size)
- 4.0 oz and larger — ❌ Must go in checked bag

> [!TIP]
> Toothpaste tablets are an excellent travel alternative. They are dry solids that are completely exempt from the liquid limit, require no toothpaste tube, and take up almost no space.
...
**Q: What is the TSA liquid limit?**
A: The TSA liquid limit is 3.4 oz (100ml) per container in carry-on bags. All liquid containers must fit inside one quart-sized (approximately 1-liter) clear, resealable zip-top bag. One bag is allowed per passenger.

**Q: What are the TSA liquid rules?**
A: TSA liquid rules follow the 3-1-1 system: (1) containers of 3.4 oz/100ml or less, (2) all in one clear quart-sized bag, (3) one bag per person. Any liquid-format item — including gels, pastes, aerosols, and creams — follows this rule in carry-on bags.

**Q: Is deodorant a liquid per TSA rules?**
A: It depends on the type. Solid stick deodorant is NOT a liquid and has no size restrictions. Gel deodorant, roll-on deodorant, spray deodorant, and cream deodorant ARE liquids and must be 3.4 oz or less in carry-on bags.

**Q: Is toothpaste a liquid for TSA?**
A: Yes. Toothpaste is classified as a gel/paste and is subject to the TSA 3-1-1 liquid limit. Only containers of 3.4 oz (100ml) or less are allowed in carry-on bags. Full-size toothpaste (4 oz+) must go in your checked bag. Toothpaste tablets are solid and exempt from the rule.

**Q: Can I bring a water bottle through TSA?**
...
The TSA 3-1-1 rule remains one of the most strictly enforced security protocols in modern aviation. By packing smart, utilizing solid alternatives, and properly declaring medical exemptions, you can breeze through the checkpoint without abandoning your favorite toiletries.
...
- [TSA Liquids Rule Overview](https://www.tsa.gov/travel/security-screening/liquids-rule)
- [FAA Hazardous Materials Guidelines](https://www.faa.gov/hazmat/packsafe/)
