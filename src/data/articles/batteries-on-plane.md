---
title: "Can You Bring Batteries on a Plane? TSA Rules for AA, AAA & Lithium"
description: "Can you bring batteries on a plane? Full TSA rules for AA, AAA, lithium, and rechargeable batteries in carry-on and checked bags — with airline limits."
...
| C and D batteries | ✅ Allowed | ✅ Allowed |
| 9V alkaline batteries | ✅ Allowed | ✅ Allowed |
| Lithium AA/AAA (non-rechargeable) | ✅ Allowed | ✅ Allowed |
...
- Common in: certain AA/AAA batteries, CR123A, CR2032 button cells
- Carry-on: ✅ Allowed
...
|---|---|---|
| Under 100Wh | ✅ Allowed | ✅ In device only (spares in carry-on) |
| 100–160Wh | ✅ With airline approval | ❌ Prohibited |
...
## Protecting Batteries at Security and in Luggage

TSA recommends protecting battery terminals to prevent accidental short circuits:
...
Most airlines follow FAA regulations, but some have additional rules:

| Airline | AA/AAA | Lithium Spare (under 100Wh) | Lithium in Device (checked) |
|---|---|---|---|
| **Delta** | ✅ Either bag | ✅ Carry-on only | ✅ Checked OK |
| **United** | ✅ Either bag | ✅ Carry-on only | ✅ Checked OK |
| **American** | ✅ Either bag | ✅ Carry-on only | ✅ Checked OK |
| **Ryanair** | ✅ Either bag | ✅ Carry-on only | ✅ Checked OK |
| **Emirates** | ✅ Either bag | ✅ Carry-on only | ✅ Checked OK |
...
- **Mistake 1: Putting spare lithium-ion batteries in checked luggage.** This is prohibited. All spare rechargeable batteries must travel in carry-on bags.
- **Mistake 2: Leaving batteries loose in a bag with metal items.** Metal objects can bridge battery terminals and cause short circuits. Keep batteries protected.
- **Mistake 3: Traveling with car/motorcycle batteries.** Lead-acid vehicle batteries are prohibited on passenger aircraft — carry-on and checked.
...
A: AA, AAA, and alkaline batteries are allowed in carry-on and checked bags. Lithium-ion spare batteries must be in carry-on only.

**Q: Are AA batteries allowed on planes?**
A: Yes. AA alkaline batteries are permitted in carry-on and checked baggage with no restrictions.
...
A: Yes. CR2032 and other button cell batteries are allowed in both carry-on and checked baggage.

**Q: Are lithium batteries allowed on planes?**
A: Lithium batteries installed in devices are allowed in checked bags. Spare lithium batteries must travel in carry-on only, in original packaging or with protected terminals.

**Q: Can you bring rechargeable batteries on a plane?**
A: Yes. NiMH rechargeable AA/AAA are unrestricted. Lithium-ion rechargeable spares must be in carry-on.

---

## Conclusion

Alkaline batteries (AA, AAA, C, D, 9V) are the simplest case — they go anywhere in any quantity. The critical rule is for lithium-ion batteries: spare rechargeable batteries must always be in carry-on, never in checked bags. Protect all loose battery terminals to prevent short circuits, and you'll have no issues at any airport security checkpoint worldwide.

---

## Official References

- [FAA Lithium Battery Safety](https://www.faa.gov/hazmat/packsafe/more_info/?hazmat=7)
- [TSA Batteries Guidelines](https://www.tsa.gov/travel/security-screening/whatcanibring/items/batteries)
